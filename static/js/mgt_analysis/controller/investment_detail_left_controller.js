ampApp.controller("investment-detail-left-controller",["$scope","$rootScope",function($scope,$rootScope){
    ...
    function initPageView(){
        container = $("#investment-detail-left");
    ...
    function bindPageEvents(){
        ...
        container.on("click touchend","a.enrolment-btn",function(e){
            e.stopPropagation();
            e.preventDefault();
            $rootScope.$broadcast("investment-detail.enrolment");
        });
    }
