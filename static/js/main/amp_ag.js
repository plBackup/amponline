...
ampApp.config(["$stateProvider","$urlRouterProvider",function($stateProvider,$urlRouterProvider) {
    ...
    // 风控分析 - 投资分析方案
    $stateProvider.state("risctrl_page", {
        url: "/risctrl_page",
        views: {
            "toolbar": {
            },
            "content": {
                controller:"riskctrl_controller",
                templateUrl: "../views/riskctrl/riskctrl.html"
            },
            "right": {
            }
        },
    ...
    // 风控分析 - 投资分析方案 - 详情
    $stateProvider.state("risctrl_detail_page", {
        url: "/risctrl_detail_page",
        views: {
            "toolbar": {
            },
            "content": {
                controller:"ctrl-detail",
                templateUrl: "../views/riskctrl/riskctrl_detail.html"
            },
            "right": {
            }
        },
    ...
    // noi 录入
    $stateProvider.state("noi_enrolment", {
        url: "/noi_enrolment",
        views: {
            "toolbar": {
                controller:"noi-enrolment-left-controller",
                templateUrl: "../noi_analysis/noi_enrolment_left.html"
            },
            "content": {
                controller:"noi-enrolment-controller",
                templateUrl: "../noi_analysis/noi_enrolment.html"
            },
            "enrolment": {
            }
        },
