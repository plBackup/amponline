ampApp.controller("noi-enrolment-left-controller",["$scope","$rootScope",function($scope,$rootScope){
    ...
    function bindPageEvents(){
        $(container).on("click touchend",".amp-date-selector .amp-date-selector-prev",function(e){
            ...
            $rootScope.$broadcast("noi-enrolment.change-month",newDate.getFullYear()+"-"+monthText);
        });
